...
public class RouteGridViewAdapter extends BaseAdapter {
	...
	public RouteGridViewAdapter(Context ctx, ArrayList<String> urls, ArrayList<String> urls2) {
		this.ctx = ctx;
		this.imageUrls = urls;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = View.inflate(ctx, R.layout.grid_view_route, null);
