...
public lbs(int lbs_id, double lbsx, double lbsy, int track_id, int iscontain) {
	super();
	this.lbs_id = lbs_id;
	this.lbsx = lbsx;
	this.lbsy = lbsy;
...
public String toString() {
	return "lbs [lbs_id=" + lbs_id + ", lbsx=" + lbsx + ", lbsy=" + lbsy
			+ ", track_id=" + track_id + ", iscontain=" + iscontain + "]";
}
