...
import com.whut.myMap.fragment.Rate_point;
import com.whut.myMap.fragment.Rate_route;
...
public class MyRate extends FragmentActivity{
	...
	private void initViews() {
		...
		mFragments.add(new Rate_point());
		mFragments.add(new Rate_route());
